...
import { useSSRContext, ref, resolveComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode } from "vue";
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    const login = async () => {
      let result2 = await loginService(registerData.value);
      ElMessage.success("登录成功!");
      tokenStore.setToken(result2.data);
      router2.push("/");
    };
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_el_form_item, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<h1 data-v-e4df1880${_scopeId4}>注册</h1>`);
                              } else {
                                return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_el_form_item, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<h1 data-v-e4df1880${_scopeId4}>登录</h1>`);
                              } else {
                                return [
                          ...
                          _push4(ssrRenderComponent(_component_el_form_item, { class: "flex" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="flex" data-v-e4df1880${_scopeId4}>`);
...
const LoginVue = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-e4df1880"]]);
const _sfc_main$9 = {
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_aside, { width: "200px" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="el-aside__logo" data-v-625686a5${_scopeId2}></div>`);
                        ...
                        _push4(ssrRenderComponent(_component_el_sub_menu, { index: "1" }, {
                          title: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-625686a5${_scopeId4}>文章分类</span>`);
                            } else {
                              return [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/article/category" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>详细分类</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/article/category-chart" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>图表分析</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                        ...
                        _push4(ssrRenderComponent(_component_el_sub_menu, { index: "2" }, {
                          title: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-625686a5${_scopeId4}>文章管理</span>`);
                            } else {
                              return [
                                createVNode(_component_el_icon, null, {
                                  default: withCtx(() => [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/article/manage" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>文章管理</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                        ...
                        _push4(ssrRenderComponent(_component_el_sub_menu, { index: "3" }, {
                          title: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-625686a5${_scopeId4}>个人中心</span>`);
                            } else {
                              return [
                                createVNode(_component_el_icon, null, {
                                  default: withCtx(() => [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/user/info" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>基本资料</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/user/avatar" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>更换头像</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                              ...
                              _push5(ssrRenderComponent(_component_el_menu_item, { index: "/user/password" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span data-v-625686a5${_scopeId5}>重置密码</span>`);
                                  } else {
                                    return [
                                      createVNode(_component_el_icon, null, {
                                        default: withCtx(() => [
                        ...
                        _push4(ssrRenderComponent(_component_el_menu_item, { index: "/user/char" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-625686a5${_scopeId4}>绩效分析</span>`);
                            } else {
                              return [
                                createVNode(_component_el_icon, null, {
                                  default: withCtx(() => [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_header, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-625686a5${_scopeId3}>黑马程序员：<strong data-v-625686a5${_scopeId3}>牛牛</strong></div>`);
                        _push4(ssrRenderComponent(_component_el_dropdown, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<span class="el-dropdown__box" data-v-625686a5${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_el_avatar, null, null, _parent5, _scopeId4));
                              _push5(ssrRenderComponent(_component_el_icon, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
...
const LayoutVue = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-625686a5"]]);
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    const getAllCategory = async () => {
      let result2 = await articleCategoryListService();
      categorys.value = result2.data;
    };
    getAllCategory();
    ...
    const addCategory = async () => {
      let result2 = await articleCategoryAddService(categoryModel.value);
      ElMessage.success(result2.message ? result2.message : "添加成功");
      clearcategoryModel();
    ...
    const updateCategory = async () => {
      let result2 = await articleCategoryUpdateService(categoryModel.value);
      ElMessage.success(result2.message ? result2.message : "修改成功");
      dialogVisible.value = false;
      getAllCategory();
    };
    const deleteCategory = (row) => {
      ElMessageBox.confirm(
        ...
        let result2 = await articleCategoryDeleteService(row.id);
        ElMessage.success(result2.message ? result2.message : "删除成功");
        getAllCategory();
      }).catch(() => {
        ElMessage({
          type: "info",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_card, mergeProps({ class: "page-container" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header" data-v-88b829e9${_scopeId}><span data-v-88b829e9${_scopeId}>文章分类</span><div class="extra" data-v-88b829e9${_scopeId}>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_dialog, {
              ...
              footer: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="dialog-footer" data-v-88b829e9${_scopeId2}>`);
...
const ArticleCategoryVue = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-88b829e9"]]);
const _sfc_main$7 = {
...
const ArticleCategoryChart = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-d43b73b6"]]);
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_card, mergeProps({ class: "page-container" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header" data-v-8be30d3a${_scopeId}><span data-v-8be30d3a${_scopeId}>文章管理</span><div class="extra" data-v-8be30d3a${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
              type: "primary",
              onClick: ($event) => {
                clear();
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_el_upload, {
                                ...
                                action: "/api/upload",
                                name: "file",
                                headers: { "Authorization": _ctx.tokenStore.token },
                                "on-success": uploadSuccess
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (articleModel.value.coverImg) {
                                      _push6(`<img${ssrRenderAttr("src", articleModel.value.coverImg)} class="avatar" data-v-8be30d3a${_scopeId5}>`);
                                    } else {
                        ...
                        _push4(ssrRenderComponent(_component_el_form_item, { label: "文章内容" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="editor" data-v-8be30d3a${_scopeId4}>`);
...
const ArticleManageVue = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-8be30d3a"]]);
const _sfc_main$5 = {
  __name: "ArticleChart",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    getArticleCategoryList();
    const getArticles = async () => {
      let result2 = await articleListsService();
      articles.value = result2.data;
      updateOptionData();
    };
    getArticles();
    const dataviews = ref([]);
...
const ArticleManageCharVue = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-14451a48"]]);
const _sfc_main$4 = {
  __name: "UserInfo",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const updateUserInfo = async () => {
      let result2 = await userInfoUpdateService(userInfo.value);
      ElMessage.success(result2.message ? result2.message : "修改成功");
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const uploadSuccess = (result2) => {
      imgUrl.value = result2.data;
    };
    const updateAvatar = async () => {
      let result2 = await userAvatarUpdateService(imgUrl.value);
      ElMessage.success(result2.message ? result2.message : "修改成功");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_card, mergeProps({ class: "page-container" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header" data-v-2af56af0${_scopeId}><span data-v-2af56af0${_scopeId}>更换头像</span></div>`);
          } else {
            return [
              createVNode("div", { class: "header" }, [
                createVNode("span", null, "更换头像")
                  ...
                  _push3(ssrRenderComponent(_component_el_col, { span: 12 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_upload, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` &gt; `);
                              if (imgUrl.value) {
                                _push5(`<img${ssrRenderAttr("src", imgUrl.value)} class="avatar" data-v-2af56af0${_scopeId4}>`);
                              } else {
                                _push5(`<img width="278" data-v-2af56af0${_scopeId4}>`);
                              }
                            } else {
                              return [
                                createTextVNode(" > "),
                        ...
                        _push4(`<br data-v-2af56af0${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_el_button, {
                          type: "primary",
                          icon: unref(Plus),
                          size: "large",
...
const UserAvatarVUe = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2af56af0"]]);
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const updateUserPassword = async () => {
      let result2 = await userPasswordUpdateService(updatepasswordData.value);
      ElMessage.success(result2.message ? result2.message : "修改成功");
      await router.push("/login");
    };
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const getPerformanceList = async () => {
      let result2 = await PerformanceListService();
      performances.value = result2.data;
      updatePerformance();
      console.log(option);
    };
    getPerformanceList();
...
const UserCharVue = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-28639307"]]);
const routes = [
